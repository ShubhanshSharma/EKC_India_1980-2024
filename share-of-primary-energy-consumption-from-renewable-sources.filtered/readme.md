...
This data package contains the data that powers the chart ["Share of primary energy consumption from renewable sources"](https://ourworldindata.org/explorers/energy?tab=line&facet=none&overlay=download-data&hideControls=true&Total+or+Breakdown=Select+a+source&Energy+or+Electricity=Primary+energy&Metric=Share+of+total&Select+a+source=Renewables&country=~IND) on the Our World in Data website. It was downloaded on January 29, 2026.
