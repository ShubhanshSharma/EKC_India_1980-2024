...
This data package contains the data that powers the chart ["Energy consumption by source"](https://ourworldindata.org/grapher/energy-consumption-by-source-and-country?stackMode=absolute&time=1980..latest&country=~IND&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
